...
FieldBook  contruye libretas de campo, el cual sigue  un correcta estructuración de los datos para su posterior análisis, exportando la libreta en un estructura  que entienda el computador. Pero, ¿Qué son los datos estructurados?
...
A continuación, un ejemplo. Se realiza un experimento donde se desea saber el efecto de una enfermedad sobre  indiviudos de la misma especie pero diferentes cargas genéticas.
...
*recomendación:*
Adicionalmente se recomienda dejar anotada en una hoja adicional, la construcción de la leyendas para la contrucción de variables, como las unidades en las que serán medidas, la fecha, entre otras anotaciones que el responsable considere importante.
